  ...
  return (
   ...
   <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="px-6 py-12 outline -outline-offset-1 outline-white/10 sm:rounded-lg sm:px-12">
            ...
            <div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <a
                  href="#"
                  className="flex w-full items-center justify-center gap-3 rounded-md bg-white/10 px-3 py-2 text-sm font-semibold  inset-ring inset-ring-white/5 hover:bg-white/20 focus-visible:inset-ring-transparent"
                >
